...
def single_test(file: String): Unit = {
  val contents = os.read("/home/zuoyuan/IdeaProjects/scala-compiler-homework/examples/fortest.while")
  println(s"Lex $file: ")
...
//@main
//def test(): Unit = {
//var file: String = "/home/zuoyuan/IdeaProjects/scala-compiler-homework/examples/fortest.while"
